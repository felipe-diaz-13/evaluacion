...
export const showUser = async (req, res) => {
  try {
    ...
    await userInstance.showUser(res);
  } catch (error) {
...
export const showUserId = async (req, res) => {
  try {
    const userInstance = new UserModel();
    await userInstance.showUserById(res, req);
  } catch (error) {
...
export const addUser = async (req, res) => {
  try {
    const userInstance = new UserModel();
    await userInstance.addUser(req, res);
  } catch (error) {
...
export const updateUser = async (req, res) => {
  try {
    const userInstance = new UserModel();
    await userInstance.updateUser(req, res);
  } catch (error) {
...
export const deleteUser = async (req, res) => {
  try {
    const userInstance = new UserModel();
    await userInstance.deleteUser(req, res);
  } catch (error) {
